    ...
    <div :style="isOpen ? showHambuger : null"
      ...
      <nav role="navigation"
        ...
        <div class="flex justify-center gap-4 pb-4 hover:text-accent">
          <router-link to="/" class="m-0 max-w-[220px]"><img src="@/assets/logo.png" alt="" />
            <h1 class="text-text-color text-center text-3xl font-headers hover:text-accent">
              The Sandbox
            </h1>
          </router-link>
        </div>
          ...
          <ul class="space-y-2 px-4 place-items-center">
            <li>
              <router-link to="explore"
                class="flex justify-center text-text-color font-headers tracking-wider uppercase text-2xl hover:text-accent transition hover:scale-110 ease-in-out">
                Explore
              </router-link>
            </li>
            <li class="content-center">
              <router-link to="shop"
                class="flex justify-center gap-4 text-text-color font-headers tracking-wider uppercase text-2xl hover:text-accent transition hover:scale-110 ease-in-out">
                Shop</router-link>
            </li>
            <li>
            ...
            <li>
              <a class="flex justify-center gap-4 text-text-color font-headers tracking-wider uppercase text-2xl hover:text-accent transition hover:scale-110 ease-in-out"
                v-if="isLoggedIn" @click="logout">Logout</a>
              <a href="/login"
                class="flex justify-center gap-4 text-text-color font-headers tracking-wider uppercase text-2xl hover:text-accent transition hover:scale-110 ease-in-out"
                v-else>Login</a>
            </li>
