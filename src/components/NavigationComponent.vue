            ...
            <ul class="space-y-2 px-4 place-items-center">
              <li>
                <router-link to="explore"
                  class="flex justify-center text-text-color font-headers tracking-wider uppercase text-4xl md:text-2xl hover:text-accent transition hover:scale-110 ease-in-out">
                  Explore
                </router-link>
              </li>
